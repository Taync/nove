                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      Text("Beden Seçimi", style: TextStyle(fontWeight: FontWeight.bold)),
                      SizedBox(height: 10),
                      Wrap(
                        spacing: 10,
...
bottomNavigationBar: Column(
  ...
  try {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content:
            Text("${widget.productName} ($_selectedSize) sepete eklendi!"),
      ),
    );
  } catch (e) {
    ScaffoldMessenger.of(context).showSnackBar(
...
,
            ...
            label: Text("ADD CART", style: TextStyle(color: Colors.white)),
