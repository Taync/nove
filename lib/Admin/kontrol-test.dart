//BU SAYFA ADDPRODUCT SAYFASINDA OLUŞAN HATALARI İNCELEMEK İÇİN ADDPRODUCT'IN BİR KOPYASIDIR
import 'dart:io';
...
final List<String> brandItem = [
  ...
  void uploadItem() {
  if (file != null && namecontroller.text.isNotEmpty && value != null && selectedBrand != null) {
